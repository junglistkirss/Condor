    ...
    public sealed class TargetTypeVisitor : SymbolVisitor<TargetTypeInfo>
    {
        ...
        public override TargetTypeInfo VisitNamedType(INamedTypeSymbol x)
        {
            return new TargetTypeInfo
            {
                ...
                Interfaces = [.. x.Interfaces.Select(x => x.Accept(Instance))],
                AllInterfaces = [.. x.AllInterfaces.Select(x => x.Accept(Instance))],
                ...
                GenericTypes = x.IsGenericType ? [.. x.TypeParameters.Select(x => x.Accept(TypeArgumentVisitor.Instance))] : [],
            };
        }
        ...
        public override TargetTypeInfo VisitArrayType(IArrayTypeSymbol x)
        {
            return new TargetTypeInfo
            {
                ...
                Interfaces = [.. x.ElementType.Interfaces.Select(x => x.Accept(Instance))],
                AllInterfaces = [.. x.ElementType.AllInterfaces.Select(x => x.Accept(Instance))],
